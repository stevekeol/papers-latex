...
\usetikzlibrary {arrows.meta,automata,positioning,shadows} % use for topo graph
...
\lstdefinestyle{mystyle}{ % use for source code too
...
\lstset{style=mystyle} % use for source code too
